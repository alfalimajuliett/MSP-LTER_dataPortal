...
var ZOTERO_CONFIG = {
   ...
   "collectionKey": "47YTIFFL", // Key of collection within library to search, e.g., "KHTHLKB5", or "" if no collection
   ...
   "showTags": ["LTER_Legacy"], // Include a column showing this tag if present for each item
